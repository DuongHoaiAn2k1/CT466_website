    ...
    <div class="single_product">
      ...
      >
          ...
          <div class="col-lg-6 order-3">
            <div class="product_description">
              ...
              <div>
                ...
                ><br />
                <span class="product_info">Warranty: 6 months warranty</span
                ><br />
                <span class="product_info">7 Days easy return policy</span
                ><br />
                <span class="product_info">7 Days easy return policy</span
                ><br />
                <span class="product_info"
                  >In Stock: 25 units sold this week</span
                >
              </div>
              <div>
                <div class="row">
        ...
        <div class="row row-underline">
          <div class="col-md-6">
            <span class="deal-text">Combo Offers</span>
          </div>
          <div class="col-md-6">
                ...
                <div class="bbb_combo">
                  ...
                  <div class="d-flex flex-row justify-content-start">
                    <strike style="color: red">
                      <span class="fs-10" style="color: black"
                        >₹ 32,000<span> </span></span
                    ></strike>
                    <span class="ml-auto"
                  ...
                  >
                    <span style="margin-top: -4px">₹30,000</span>
                    <span class="ml-auto fs-10">23 Reviews</span>
                  </div>
            ...
            <div class="row">
              <div class="col-xs-12" style="margin-left: 36px">
                <div class="boxo-pricing-items">
                  <div class="combo-pricing-item">
                    <span class="items_text">1 Item</span>
                    <span class="combo_item_price">₹13,200</span>
                  </div>
                  <div class="combo-plus"><span class="plus-sign">+</span></div>
                  <div class="combo-pricing-item">
                    <span class="items_text">1 Add-on</span>
                    <span class="combo_item_price">₹500</span>
                  </div>
                  <div class="combo-plus"><span class="plus-sign">=</span></div>
                  <div class="combo-pricing-item">
                    <span class="items_text">Total</span>
                    <span class="combo_item_price">₹13,700</span>
                  </div>
                ...
                <div class="bbb_combo">
                  ...
                  <div class="d-flex flex-row justify-content-start">
                    ...
                    <span class="ml-auto"
                      ><i class="fa fa-star p-rating"></i
                      ><i class="fa fa-star p-rating"></i
                      ><i class="fa fa-star p-rating p-rating"></i
                      ><i class="fa fa-star p-rating"></i
                    ></span>
                  </div>
                  <div
          ...
          <div class="col-md-12">
            <table class="col-md-12">
              <tbody>
                ...
                <tr class="row mt-10">
                  <td class="col-md-4">
                    <span class="p_specification">Model Number :</span>
                  </td>
                  <td class="col-md-8">
                    <ul>
                      <li>14-dh0107TU</li>
                ...
                <tr class="row mt-10">
                  <td class="col-md-4">
                    <span class="p_specification">Part Number :</span>
                  </td>
                  <td class="col-md-8">
                    <ul>
                      <li>7AL87PA</li>
                ...
                <tr class="row mt-10">
                  <td class="col-md-4">
                    <span class="p_specification">Color :</span>
                  </td>
                  <td class="col-md-8">
                    <ul>
                      <li>Black</li>
                ...
                <tr class="row mt-10">
                  <td class="col-md-4">
                    <span class="p_specification">Suitable for :</span>
                  </td>
                  <td class="col-md-8">
                    <ul>
                ...
                <tr class="row mt-10">
                  <td class="col-md-4">
                    <span class="p_specification">Processor Brand :</span>
                  </td>
                  <td class="col-md-8">
                    <ul>
                      <li>Intel</li>
